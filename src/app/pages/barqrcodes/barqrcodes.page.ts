...
@Component({
  selector: 'app-barqrcodes',
  templateUrl: './barqrcodes.page.html',
  styleUrls: ['./barqrcodes.page.scss'],
})
export class BarqrcodesPage implements OnInit {
...
export class BarqrcodesPageModule {}
