...
@Component({
  selector: 'app-routesmapping',
  templateUrl: './routesmapping.page.html',
  styleUrls: ['./routesmapping.page.scss'],
})
export class RoutesmappingPage implements OnInit {
